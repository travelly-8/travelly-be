...
public class QReservationTicket extends EntityPathBase<ReservationTicket> {
    ...
    private static final long serialVersionUID = -958009802L;
    ...
    public final com.demo.travellybe.product.domain.QTicket ticket;
    ...
    public QReservationTicket(Class<? extends ReservationTicket> type, PathMetadata metadata, PathInits inits) {
        ...
        this.ticket = inits.isInitialized("ticket") ? new com.demo.travellybe.product.domain.QTicket(forProperty("ticket"), inits.get("ticket")) : null;
    }
